...
chatToggle.addEventListener('click', () => {
  ...
  // Chamada para registrar o acesso ao chat
  fetch('/registrar-acesso', { method: 'POST' });

  if (!chatMessages.hasChildNodes()) {
    addBotMessage('Olá! Seja bem-vindo(a) à PE Motos. Como podemos ajudar você hoje? Se deseja simular alguma moto, é só digitar "Quero simular"');
  }
});
